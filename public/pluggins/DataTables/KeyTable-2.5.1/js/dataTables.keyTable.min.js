...
(function (b) {
    ...
    b.extend(p.prototype, {
        ...
        _constructor: function () {
            ...
            if (this.c.blurable) b(k).on("mousedown" + d, function (d) {
            ...
            if (this.c.editor) {
                ...
                q.on("open.keyTableMain", function (c, b, e) {
                    "inline" !== b && a.s.enable && (a.enable(!1), q.one("close" + d, function () {
                        a.enable(!0)
                    }))
                });
                if (this.c.editOnFocus) c.on("key-focus" + d + " key-refocus" + d, function (c, b, d, e) {
                    a._editor(null, e, !0)
                });
            ...
            if (c.settings()[0].oFeatures.bStateSave) c.on("stateSaveParams" + d, function (b, c, d) {
            ...
            c.on("draw" + d, function (d) {
                if (!a.s.focusDraw) {
                    ...
                    if (e && e.node && b(e.node).closest("body") === k.body) {
                        ...
                        var m = c.page.info(),
                            h = e.row + m.start;
                        0 !== m.recordsDisplay && (h >= m.recordsDisplay &&
        ...
        _clipboard: function () {
            ...
            f.getSelection && (b(k).on("copy" + e, function (a) {
                ...
                var d = c.s.lastFocus,
                    ...
                    h = c.c.editor,
                    n;
                !d || e && "body" !== e.nodeName.toLowerCase() || (b.preventDefault(), f.clipboardData && f.clipboardData.getData ? n = f.clipboardData.getData("Text") : b.clipboardData && b.clipboardData.getData && (n = b.clipboardData.getData("text/plain")), h ? h.inline(d.cell.index()).set(h.displayed()[0], n).submit() : (d.cell.data(n), a.draw(!1)))
            }))
        },
        _columns: function () {
            var a = this.s.dt,
        ...
        _focus: function (a, c, e, d) {
            ...
            if (this.s.enable) {
                ...
                if (-1 !== h.length && (a < h.start || a >= h.start + h.length)) this.s.focusDraw = !0, this.s.waitingForDraw = !0, g.one("draw",
                    function () {
                        m.s.focusDraw = !1;
                    ...
                    if (e === l || !0 === e) this._scroll(b(f), b(k.body), n, "offset"),
                        e = g.table().body().parentNode, e !== g.table().header().parentNode && (e = b(e.parentNode), this._scroll(e, e, n, "position"));
                    this.s.lastFocus = {
                        cell: h,
                        node: h.node(),
                        relative: {
        ...
        _key: function (a) {
            if (this.s.waitingForDraw) a.preventDefault();
                ...
                if (c && (!(0 === a.keyCode || a.ctrlKey || a.metaKey || a.altKey) || a.ctrlKey &&
                    a.altKey)) {
                    ...
                    if (d)
                        if (this.s.dt.cell(d.node).any()) {
                            ...
                            if (!this.c.keys || -1 !== b.inArray(a.keyCode, this.c.keys)) switch (a.keyCode) {
                                ...
                                case 33:
                                case 34:
                                    e && !m && (a.preventDefault(), d.page(33 === a.keyCode ? "previous" : "next").draw(!1));
                                    break;
                                case 35:
                                case 36:
                                    e && (a.preventDefault(), c = d.cells({
                                        page: "current"
                                    }).indexes(), e = this._columns(),
        ...
        _shift: function (a, c, e) {
            ...
            if (h) {
                ...
                f = g[d];
                "right" === c ? d >= g.length - 1 ? (l++ , f = g[0]) : f = g[d + 1] : "left" === c ? 0 === d ? (l-- , f = g[g.length - 1]) : f = g[d - 1] : "up" === c ? l-- : "down" === c && l++;
                0 <= l && l < k && -1 !== b.inArray(f, g) ? (a && a.preventDefault(), this._focus(l, f, !0, a)) : e && this.c.blurable ? this._blur() : a && a.preventDefault()
            }
        },
        _tabInput: function () {
            var a = this,
                c = this.s.dt,
                e = null !== this.c.tabIndex ?
                    this.c.tabIndex : c.settings()[0].iTabIndex;
            if (-1 != e) b('<div><input type="text" tabindex="' + e + '"/></div>').css({
                position: "absolute",
                height: 1,
                width: 0,
                overflow: "hidden"
        ...
        _updateFixedColumns: function (a) {
            ...
            if (e._oFixedColumns) {
                ...
                (a < e._oFixedColumns.s.iLeftColumns || a >=
    ...
    g.ext.selector.cell.push(function (a, b, e) {
        ...
        for (var f = 0, g = e.length; f <
            g; f++)(!0 === b && a.focused(e[f]) || !1 === b && !a.focused(e[f])) && c.push(e[f]);
        return c
    });
    b(k).on("preInit.dt.dtk", function (a, c, e) {
        "dt" === a.namespace && (a = c.oInit.keys, e = g.defaults.keys, a || e) && (e = b.extend({}, e, a), !1 !== a && new p(c, e))
    });
    return p
});